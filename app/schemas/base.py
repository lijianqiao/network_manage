...
class BaseCreateSchema(BaseSchema):
    """基础创建Schema"""
    description: Optional[str] = Field(default=None, max_length=500, description="描述信息")
...
class BatchOperationResponse(BaseSchema):
    ...
    failed_items: Optional[List[dict[str, Any]]] = Field(default=None, description="失败项目详情")
...
ListResponse = Union[PaginationResponse[T], ErrorResponse]
