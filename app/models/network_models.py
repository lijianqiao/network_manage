...
class TemplateCommand(BaseModel):
    ...
    config_template = fields.ForeignKeyField("models.ConfigTemplate", related_name="template_commands", description="关联配置模板")
...
class OperationLog(BaseModel):
    ...
    template = fields.ForeignKeyField("models.ConfigTemplate", related_name="operation_logs", null=True, description="使用的模板")
...
class ConfigSnapshot(BaseModel):
    ...
    operation_log = fields.ForeignKeyField("models.OperationLog", related_name="config_snapshots", null=True, description="关联操作记录")
...
class ConfigDiff(BaseModel):
    ...
    before_snapshot = fields.ForeignKeyField("models.ConfigSnapshot", related_name="before_diffs", description="变更前快照")
    after_snapshot = fields.ForeignKeyField("models.ConfigSnapshot", related_name="after_diffs", description="变更后快照")
...
class RollbackOperation(BaseModel):
    ...
    original_operation = fields.ForeignKeyField("models.OperationLog", related_name="rollback_operations", description="原始操作记录")
    target_snapshot = fields.ForeignKeyField("models.ConfigSnapshot", related_name="rollback_operations", description="目标回滚快照")
